...
namespace _2member__3member_frame_with_spring
{
    public partial class Form1 : Form
    {
        ...
        //===========================================================
        //==============================================================
        private int[] Index_6_From_MemID_1D_1_7_HINGE(int mem_id)// FOR HINGE
        {  
            int HINGE_Num_total=1;
        int[] Index_6 = new int[(totalnode * 3) + 1 + HINGE_Num_total];//ok
            ////int[] Index_6 = new int[7];//inded outside range
            Index_6[0] = 0;
            Index_6[1] = Connectivity[mem_id, 1] * 3 - 2;
            Index_6[2] = Connectivity[mem_id, 1] * 3 - 1;
            Index_6[3] = Connectivity[mem_id, 1] * 3;
            ...
            //    {
                    ...
                    //if (mem_id == 2)   Index_6[3] = 13;// start
                    if (mem_id == 2) Index_6[6]=13 ;// end
                    Debug.Print(mem_id + " mem_id, Index_6[6] "
                         + Index_6[6]);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            FIXED_END_MEMBER_LOCAL_REACTION[2, 7] = 0;//6>> local x
            ...
            Debug.Print("K_SSM_Rearranged Global Structure Stiffnes Matrix:" + Environment.NewLine + MakeDisplayable_2D2D_ij_1_1(K_SSM_Rearranged));
            //End K_SSM_Rearranged................................................................
            //"..rearange ssm DONe.............


            //Kff............................................................................
            Debug.Print("DOF_Free.Length= " + DOF_Free.Length.ToString());
            double[,] Kff = new double[DOF_Free.Length, DOF_Free.Length]; //Kff
            for (i = 0; i < DOF_Free.Length; i++)
            {
                for (j = 0; j < DOF_Free.Length; j++)
                {
                    Kff[i, j] = K_SSM_Rearranged[i + 1, j + 1]; //Kff  start from 0, K_SSM_Rearranged start from 1 
            ...
            Debug.Print("START Solution for Ksf LOWER LEFT PART OF K_SSM_Rearranged...................");
            ...
            for (i = DOF_Free.Length + 1; i <= totalnode * 3; i++)
            {
                ...
                {
                    Ksf[i - DOF_Free.Length - 1, j - 1] = K_SSM_Rearranged[i, j]; ////Ksf start from 0, K_SSM_Rearranged start from 1 
                    //Debug.Print("TEST Ksf LOWER LEFT PART OF K_SSM_Rearranged " + (DOF_Free.Length + 1).ToString + "TO  " + (totalnode * 3).ToString)
                }
            }
            ...
            Debug.Print("Ksf Ksf LOWER LEFT PART OF K_SSM_Rearranged Matrix ..........");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            ////    {
            ////        Ksf[i, j] = K_SSM_Rearranged[DOF_Free.Length - 1 + 1 + i + 1, j + 1]; //Ksf start from 0, K_SSM_Rearranged start from 1 
            ////    }
            ////}
            ...
            double[,] Ksf = new double[DOF_Restrained.Length, DOF_Free.Length];




            for (i = 0; i <= DOF_Restrained.Length - 1; i++) //row 
            {
                for (j = 0; j <= DOF_Free.Length - 1; j++) //col 
                {
                    Ksf[i, j] = K_SSM_Rearranged[DOF_Free.Length - 1 + 1 + i + 1, j + 1]; ////Ksf start from 0, K_SSM_Rearranged start from 1 
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            //         |
            //         |P=-800kN                                                                                                                                                                
            //     2|--|--2----O|3 (Internal HINGE at end of Member 2 i.e left to node 3)
            //      |           |
            //      1           3
            //      |           |
            //      |1(Pin supp)|4(Pin supp)

            // degree of fredom i.e. DOF X, Y, Z==3 each node
            //=======================================================
            //------------------------------
            //         P
            //         ^ 
            ...
            totalElement = 3;
            int HINGE_Num_total = 1;
            // total degree of fredom 3*4=12
            // additinal degree of fredom FOR Internal HINGE at end of Member 2 i.e. at node 3 =13

            int[] DOF_Free = { 3, 4, 5, 6, 7, 8, 9, 12, 13 };
            Debug.Print("DOF_Free  :" + MakeDisplayable_1D_j_0_INT(DOF_Free));

            int[] DOF_Restrained = { 1, 2, 10, 11 }; // DOF X, Y, Z==3 each node

            Debug.Print("DOF_Restrained  :" + MakeDisplayable_1D_j_0_INT(DOF_Restrained));

            int[] ALL_DOF_Free_Restrained = Union_Matrix_1D_1D_Intger(DOF_Free, DOF_Restrained); //= {3, 4, 5, 6, 7, 8, 9, 11,1, 2, 10, 12,13 }
            ...
            double[] YL = new double[DOF_Free.Length];
            double[] XX = null;
            double[,] FIXED_END_MEMBER_LOCAL_REACTION = new double[totalElement + 1+HINGE_Num_total, totalnode * 3 + 1+HINGE_Num_total];
            Array.Clear(FIXED_END_MEMBER_LOCAL_REACTION, 0, FIXED_END_MEMBER_LOCAL_REACTION.Length);// set all value to 0
            FIXED_END_MEMBER_LOCAL_REACTION[2, 4] = 0;//4>> local x
            FIXED_END_MEMBER_LOCAL_REACTION[2, 5] = 740.740740740741;//5>local y 
            FIXED_END_MEMBER_LOCAL_REACTION[2, 6] = 555.555555555556;//6>local Mz 

            FIXED_END_MEMBER_LOCAL_REACTION[2, 7] = 0;//7>> local x
            FIXED_END_MEMBER_LOCAL_REACTION[2, 8] = 59.2592592592592;//8>local y 
            FIXED_END_MEMBER_LOCAL_REACTION[2, 9] = -111.111111111111;//13>local Mz 
            //Load Vector along Free_DOF
            ...
            YL[6] = 0; //9>local Mz 
            YL[7] = 0;//11>> local y 
            YL[8] = 111.111111111111; //13>> local Mz Hinge left to node 3
            Coordinate = new double[totalnode + 1, 3]; //The index of the 2nd dimension, 1=X Coordinate, 2=Y Coordinate
            ...
            double[,] Member_KG = null;
            double[, ,] KGM_ALL = new double[totalElement + 1, totalnode * 3 + 1 + HINGE_Num_total, totalnode * 3 + 1 + HINGE_Num_total];
            Array.Clear(KGM_ALL, 0, KGM_ALL.Length);//initiate all value 0
            double[, ,] KGM_ALL2 = new double[totalElement + 1, totalnode * 3 + 1 + HINGE_Num_total, totalnode * 3 + 1 + HINGE_Num_total];
            Array.Clear(KGM_ALL2, 0, KGM_ALL2.Length);//initiate all value 0
            ...
            for (i = 1; i <= totalElement; i++)
            {
                ...
                for (j = 1; j <= totalnode * 3 + HINGE_Num_total; j++)
                {
                    ...
                    {
                        result[j, k] = result[j, k] + KGM_ALL2[i, j, k]; /// 1000000000.0 'result(j, k) become sorted from 1 to 3*node
                    }
                }
            }
            ...
            Debug.Print("NOT Rearranged Global Structure Stiffnes Matrix..SSM = result................." + Environment.NewLine + MakeDisplayable_2D2D_ij_1_1(result));
            ...
            //End Compiling matx to get NOT Rearranged SSM..DONE......................................................

            ////// #####################################################################################################################################################

            double[,] Result_Mem_Force_global = new double[totalElement + 1, (totalnode * 3) + 1 + HINGE_Num_total];
            double[,] Result_Mem_Force_Local = new double[totalElement + 1, (totalnode * 3) + 1 + HINGE_Num_total];
            double[,] Disp_All_Nodes_Local_MembComa_NodeNum_ij_0_0 = new double[totalElement + 1, (totalnode * 3) + 1 + HINGE_Num_total];
            double[,] Disp_All_Nodes_GLOBAL_MembComa_NodeNum_ij_0_0 = new double[totalElement + 1, (totalnode * 3) + 1 + HINGE_Num_total];
            double[] Disp_All_Nodes_Global = new double[totalnode * 3 + 1 + HINGE_Num_total];
            //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

            //Start Rearange ssm where top rows dof_free and bottom rows dof_not_free
            /////INDEX TRACKING: Arrayoldindex(j,1)=col, Arrayoldindex(i,2)=row=====================================================
            ...
            for (i = 1; i <= totalnode * 3 + HINGE_Num_total; i++)
            {
                ...
                for (j = 1; j <= totalnode * 3 + HINGE_Num_total; j++)
                {
                    ...
                    K_SSM_Rearranged[i, j] = result[ALL_DOF_Free_Restrained[i - 1], ALL_DOF_Free_Restrained[j - 1]];////in order of ALL_DOF_Free_Restrained
            ...
            //////}//okkkkkkkk temp singularity function button close #####################################################################################################################################################
            ////'Start preparing Kff............................................................................
            ////'   kff   | kfs      | Df  |    | Ff |
            ////'---------|------- X |-----| =  |----| ALL GLOBAL AXEX
            ////'    ksf  |kss       | Ds  |    |Fs  |
            Debug.Print("TOTAL FREE DOOF without Specified i.e. restrained DOF= " + DOF_Free.Length.ToString());
            ...
            for (k = 1; k <= totalElement; k++)
            {
                ////===================================
                double[] Disp_j0_global = new double[6];
                double[] Disp_j0_Local=new double[6];
                double[] Force_Local_Axix = new double[totalnode * 3 + 1];
                ...
                Disp_j0_global[0] = Disp_All_Nodes_Global[indx[1]]; //d global
                Disp_j0_global[1] = Disp_All_Nodes_Global[indx[2]]; //d global
                Disp_j0_global[2] = Disp_All_Nodes_Global[indx[3]]; //d global
                Disp_j0_global[3] = Disp_All_Nodes_Global[indx[4]]; //d global
                Disp_j0_global[4] = Disp_All_Nodes_Global[indx[5]]; //d global
                Disp_j0_global[5] = Disp_All_Nodes_Global[indx[6]]; //d global
